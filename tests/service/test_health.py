...
from helix.service.health import (
    StartupError,
    check_secrets_key,
    check_storage,
    readiness,
...
class TestSecretsKeyCheck:
    ...
    def test_wrong_key_cannot_decrypt(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setenv("HELIX_SECRETS_KEY", generate_key())
...
class TestStartupValidation:
    ...
    def test_production_fails_closed_on_broken_dependency(
        ...
        monkeypatch.setenv("HELIX_ALLOWED_ORIGINS", "https://console.example")
        monkeypatch.delenv("HELIX_SECRETS_KEY", raising=False)
    ...
    def test_production_rejects_disabled_secure_cookies(
        ...
        monkeypatch.setenv("HELIX_ENV", "production")
        monkeypatch.setenv("HELIX_ALLOWED_ORIGINS", "https://console.example")
        monkeypatch.setenv("HELIX_COOKIE_SECURE", "false")
